...
from vstuxls.clash.clashing_element import *
...
def fill_clashing_elements(universe: 'ClashingElementSet'):
    ...
    for elem in universe:
        ...
        independent: ClashingElementSet = elem.data.globally_independent # type: ignore
...
def resolve_clashes5_greedy(clashing_set: 'ClashingElementSet',
                            element_limit=None,
                            accumulated_free: 'ClashingElementSet | None' = None) -> set['ClashingElementSet']:
...
def resolve_clashes5_iterative(clashing_set: 'ClashingElementSet',
    ...
    while stack:
        ...
        new_accumulated_free = ClashingElementSet(accumulated_free | always_free)
        ...
        if unused_elements:
            ...
            for arrangement in spot_arrangements:
                ready = ClashingElementSet(new_accumulated_free | arrangement)
...
@cache
def resolve_clashes5(
    clashing_set: "ClashingElementSet", element_limit=None, _depth=0
) -> set[Arrangement] | set["ClashingElementSet"]:
